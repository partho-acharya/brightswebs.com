...
function initSearchSuggestions() {
    const searchData = [
        // BG REMOVE Dropdown
        { text: 'BG REMOVE', link: 'imagebackgroundremove.html' },
        { text: 'IMAGE BACKGROUND REMOVE', link: 'imagebackgroundremove.html' },
        { text: 'IMAGE BACKGROUND EDITOR', link: 'imagebackgroundeditor.html' },
